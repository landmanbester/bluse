...
**The repository is public, and that was cleared with the BLUSE team**
(confirmed by the repository owner, 2026-09-03). Publication of the *repository*
is not publication of the *data*: the carve-out above still stands, and these
tracked tables carry hit-level identifiers that remain SARAO / Breakthrough
Listen property —
...
— so they are readable by anyone, and reuse of them is still the BLUSE team's
call rather than the MIT licence's. Czech et al. 2026 states these survey
results are destined for forthcoming publications; **cite that paper, and ask
before building on the derived tables.**
